...
#set dimensions for multiple plots
par(mfrow=c(2,2))

#plot1
plot(subset_powerdata$Time,subset_powerdata$Global_active_power,type = "l",xlab = "",ylab = "Global Active Power (kilowatts)")

#plot2
plot(subset_powerdata$Time,subset_powerdata$Voltage,type = "l",xlab = "datetime",ylab = "Voltage")
